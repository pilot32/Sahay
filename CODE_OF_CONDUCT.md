...
- Publishing others' private information (email, address) without explicit permission
...
This Code of Conduct applies within all community spaces — GitHub Issues, Pull Requests, Discussions, and any other communication channel used by the Sahay project. It also applies when an individual is officially representing the community in public spaces.
...
📧 **conduct@sahay.org** *(replace with your actual email)*
...
*Sahay is built to help people. Let's make sure our community reflects that same spirit of care and respect.* 💚